        ...
        <div class="form_holder sidebar-right1">
            <div class="row">
                <div class="predefined_styles">
                        ...
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex">
                                    <span class="me-auto">Menu Vertikal</span>
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Menu Horizontal Klik</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch15"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Menu Horizontal Hover</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch15"
                    ...
                    <div class="swichermainleft">
                        <h4>Gaya Tema Terang</h4>
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex">
                                    <span class="me-auto">Tema Terang</span>
                                ...
                                <div class="switch-toggle d-flex">
                                    <span class="me-auto">Tema Terang Primer</span>
                                    <div class="">
                        ...
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle lightMenu d-flex">
                                    <span class="me-auto">Menu Terang</span>
                                ...
                                <div class="switch-toggle colorMenu d-flex mt-2">
                                    <span class="me-auto">Menu Berwarna</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch2"
                                ...
                                <div class="switch-toggle darkMenu d-flex mt-2">
                                    <span class="me-auto">Menu Gelap</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch2"
                                ...
                                <div class="switch-toggle gradientMenu d-flex mt-2">
                                    <span class="me-auto">Menu Gradien</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch2"
                        ...
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle lightHeader d-flex">
                                    <span class="me-auto">Header Terang</span>
                                ...
                                <div class="switch-toggle  colorHeader d-flex mt-2">
                                    <span class="me-auto">Header Berwarna</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch3"
                                ...
                                <div class="switch-toggle darkHeader d-flex mt-2">
                                    <span class="me-auto">Header Gelap</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch3"
                                ...
                                <div class="switch-toggle darkHeader d-flex mt-2">
                                    <span class="me-auto">Header Gradien</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch3"
                    ...
                    <div class="swichermainleft">
                        <h4>Gaya Lebar Layout</h4>
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex">
                                    <span class="me-auto">Lebar Penuh</span>
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="skin-body">
                            <div class="switch_section">
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Dapat Digulir</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch5"
                    ...
                    <div class="swichermainleft leftmenu-styles">
                        <h4>Gaya Layout Sidemenu</h4>
                        <div class="skin-body">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex">
                                    <span class="me-auto">Menu Default</span>
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Icon dengan Teks</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch6"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Overlay Icon</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch6"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Sidemenu Tertutup</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch6"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Submenu Hover</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch6"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <span class="me-auto">Gaya Submenu Hover 1</span>
                                    <p class="onoffswitch2"><input type="radio" name="onoffswitch6"
