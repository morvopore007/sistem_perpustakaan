...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 text-end">
            <span class="text-muted">Total: {{ $borrowings->total() }} peminjaman</span>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('borrowings.show', $borrowing) }}" class="btn btn-info btn-sm" title="Lihat Detail">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        ...
                                        <form action="{{ route('borrowings.destroy', $borrowing) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus peminjaman ini?')">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ $borrowings->total() }}</h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold text-warning">{{ $borrowings->where('status', 'pending')->count() }}</h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold text-primary">{{ $borrowings->where('status', 'borrowed')->count() }}</h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold text-danger">{{ $borrowings->where('status', 'overdue')->count() }}</h3>
