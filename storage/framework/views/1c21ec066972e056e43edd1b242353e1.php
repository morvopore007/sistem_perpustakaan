                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="mt-1">
                                        <a class="bg-img bg-img1" href="javascript:void(0);"><img
                                                src="<?php echo e(asset('backend')); ?>/images/media/bg-img1.jpg" alt="Bg-Image"
                                                id="bgimage1"></a>
                                        <a class="bg-img bg-img2" href="javascript:void(0);"><img
                                                src="<?php echo e(asset('backend')); ?>/images/media/bg-img2.jpg" alt="Bg-Image"
                                                id="bgimage2"></a>
                                        <a class="bg-img bg-img3" href="javascript:void(0);"><img
                                                src="<?php echo e(asset('backend')); ?>/images/media/bg-img3.jpg" alt="Bg-Image"
                                                id="bgimage3"></a>
                                        <a class="bg-img bg-img4" href="javascript:void(0);"><img
                                                src="<?php echo e(asset('backend')); ?>/images/media/bg-img4.jpg" alt="Bg-Image"
                                                id="bgimage4"></a>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\laragon\www\sistem_perpustakaan\resources\views/auth/partials/switch.blade.php ENDPATH**/ ?>