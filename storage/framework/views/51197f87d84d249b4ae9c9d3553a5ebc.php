...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('borrow_date', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('due_date', date('Y-m-d', strtotime('+7 days')))); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="pending" <?php echo e(old('status') == 'pending' ? 'selected' : ''); ?>>Menunggu</option>
                                <option value="approved" <?php echo e(old('status') == 'approved' ? 'selected' : ''); ?>>Disetujui</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(route('borrowings.index')); ?>" class="btn btn-secondary me-2">Batal</a>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sistem_perpustakaan\resources\views/backend/borrowings/create.blade.php ENDPATH**/ ?>