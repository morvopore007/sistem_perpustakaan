                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1"><?php echo e($report['title']); ?></h4>
                            <p class="text-muted fs-13 mb-0"><?php echo e($report['description']); ?></p>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route($report['route'])); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-0"><?php echo e(\App\Models\Book::count()); ?></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-0"><?php echo e(\App\Models\User::whereIn('role', ['student', 'teacher'])->count()); ?></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-0"><?php echo e(\App\Models\Borrowing::count()); ?></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-0"><?php echo e(\App\Models\Borrowing::where('status', 'approved')->where('due_date', '<', \Carbon\Carbon::now())->count()); ?></h5>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sistem_perpustakaan\resources\views/backend/reports/index.blade.php ENDPATH**/ ?>