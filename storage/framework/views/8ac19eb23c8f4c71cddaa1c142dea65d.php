        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        <img src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : asset('frontend/avatar.png')); ?>" 
                             alt="Profile Picture" 
                             class="rounded-circle" 
                             style="width: 150px; height: 150px; object-fit: cover;">
                    </div>
                    
                    <form action="<?php echo e(route('member.profile.avatar')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      name="address" rows="3"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" 
                                   value="<?php echo e($user->created_at->format('d F Y')); ?>" readonly>
                        </div>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sistem_perpustakaan\resources\views/backend/layouts/member/profile.blade.php ENDPATH**/ ?>