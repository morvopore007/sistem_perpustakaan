...
<link rel="stylesheet" href="<?php echo e(asset('backend/custom_downloaded_file/sweetalert2.min.css')); ?>">
...
<style>
    ...
    .dark-mode .table tbody tr td small.text-muted {
        color: #adb5bd !important;
    }
    
    .dark-mode .table tbody tr td strong {
        color: #fff !important;
    }
    ...
    /* Ensure all text in dark mode tables is visible */
    .dark-mode .table td,
    .dark-mode .table th {
    ...
    /* Fix for alternating row text visibility */
    .dark-mode .table tbody tr:nth-child(odd) td,
    .dark-mode .table tbody tr:nth-child(even) td {
        color: #fff !important;
    }
...
<?php /**PATH C:\laragon\www\sistem_perpustakaan\resources\views/backend/partials/styles.blade.php ENDPATH**/ ?>